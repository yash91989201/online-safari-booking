...
export default async function Page() {
  ...
  void api.enquiry.getAll.prefetch();
      ...
      <main className="container mx-auto min-h-screen px-6 py-12">
        ...
        >
          <div className="w-full md:h-[75vh] md:w-64">
            <TabsList className="flex h-auto flex-row justify-start gap-3 md:p-3 md:h-full md:flex-col">
              <TabsTrigger
                value="enquiry"
                className="w-full justify-center rounded-lg md:justify-start"
              >
                Enquiries
              </TabsTrigger>
              <TabsTrigger
