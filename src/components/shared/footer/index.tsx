...
export const Footer = () => {
  return (
    <footer className="bg-primary text-gray-100">
      <div className="mx-auto max-w-screen-xl space-y-8 px-3 py-16 lg:space-y-16 lg:px-6">
        <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl">Online safari booking</h1>
          </div>
        ...
        <div className="grid grid-cols-1 gap-8 border-t border-border pt-8 sm:grid-cols-2 lg:grid-cols-4 lg:pt-16">
          <div>
        ...
        <p className="text-xs">
          &copy; 2025. Online Safari Booking. All rights reserved.
        </p>
      </div>
    </footer>
  );
